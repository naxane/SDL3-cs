// <auto-generated>
//  This code was generated by the following tool on 2025-05-17 15:34:26 GMT+00:00:
...
public static unsafe partial class SDL
{
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_Renderer* SDL_CreateGPURenderer(SDL_Window* window, SDL_GPUShaderFormat format_flags, SDL_GPUDevice** device);

    [LibraryImport(LibraryName, EntryPoint = "SDL_CreateGPURenderState")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_GPURenderState* SDL_CreateGPURenderState(SDL_Renderer* renderer, SDL_GPURenderStateDesc* desc);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_GetDefaultTextureScaleMode(SDL_Renderer* renderer, SDL_ScaleMode* scale_mode);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial int SDL_GetEventDescription(SDL_Event* @event, CString buf, int buflen);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_PropertiesID SDL_GetGPUDeviceProperties(SDL_GPUDevice* device);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_GetRenderTextureAddressMode(SDL_Renderer* renderer, SDL_TextureAddressMode* u_mode, SDL_TextureAddressMode* v_mode);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial int SDL_hid_get_indexed_string(SDL_hid_device* dev, int string_index, IntPtr @string, ulong maxlen);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial int SDL_hid_get_manufacturer_string(SDL_hid_device* dev, IntPtr @string, ulong maxlen);

    [LibraryImport(LibraryName, EntryPoint = "SDL_hid_get_product_string", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial int SDL_hid_get_product_string(SDL_hid_device* dev, IntPtr @string, ulong maxlen);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial int SDL_hid_get_serial_number_string(SDL_hid_device* dev, IntPtr @string, ulong maxlen);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_hid_device* SDL_hid_open(ushort vendor_id, ushort product_id, IntPtr serial_number);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_RenderGeometryRaw(SDL_Renderer* renderer, SDL_Texture* texture, float* xy, int xy_stride, Rgba32F* color, int color_stride, float* uv, int uv_stride, int num_vertices, void* indices, int num_indices, int size_indices);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_RenderTexture9GridTiled(SDL_Renderer* renderer, SDL_Texture* texture, SDL_FRect* srcrect, float left_width, float right_width, float top_height, float bottom_height, float scale, SDL_FRect* dstrect, float tileScale);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetDefaultTextureScaleMode(SDL_Renderer* renderer, SDL_ScaleMode scale_mode);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void SDL_SetGPUBlendants(SDL_GPURenderPass* render_pass, Rgba32F blend_constants);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetGPURenderStateFragmentUniforms(SDL_GPURenderState* state, uint slot_index, void* data, uint length);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetPaletteColors(SDL_Palette* palette, Rgba8U* colors, int firstcolor, int ncolors);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetRelativeMouseTransform(SDL_MouseMotionTransformCallback callback, void* userdata);
    ...
    [LibraryImport(LibraryName, EntryPoint = "SDL_SetRenderGPUState")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetRenderGPUState(SDL_Renderer* renderer, SDL_GPURenderState* state);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetRenderTextureAddressMode(SDL_Renderer* renderer, SDL_TextureAddressMode u_mode, SDL_TextureAddressMode v_mode);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetWindowProgressState(SDL_Window* window, SDL_ProgressState state);

    [LibraryImport(LibraryName, EntryPoint = "SDL_SetWindowProgressValue")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetWindowProgressValue(SDL_Window* window, float value);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_StretchSurface(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, SDL_Rect* dstrect, SDL_ScaleMode scaleMode);
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HAPTIC_AXES = (CString)"SDL_JOYSTICK_HAPTIC_AXES"u8;

    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI = (CString)"SDL_JOYSTICK_HIDAPI"u8;

    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_8BITDO = (CString)"SDL_JOYSTICK_HIDAPI_8BITDO"u8;
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_GIP = (CString)"SDL_JOYSTICK_HIDAPI_GIP"u8;

    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA = (CString)"SDL_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA"u8;
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_LG4FF = (CString)"SDL_JOYSTICK_HIDAPI_LG4FF"u8;
    ...
    public static readonly CString SDL_HINT_MAC_OPTION_AS_ALT = (CString)"SDL_MAC_OPTION_AS_ALT"u8;
    ...
    public static readonly CString SDL_HINT_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE = (CString)"SDL_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE"u8;
    ...
    public static readonly CString SDL_HINT_VIDEO_X11_EXTERNAL_WINDOW_INPUT = (CString)"SDL_VIDEO_X11_EXTERNAL_WINDOW_INPUT"u8;
    ...
    public static readonly int SDL_MICRO_VERSION = (int)0;

    public static readonly int SDL_MINOR_VERSION = (int)3;
    ...
    public static readonly CString SDL_PROP_DISPLAY_WAYLAND_WL_OUTPUT_POINTER = (CString)"SDL.display.wayland.wl_output"u8;
    ...
    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_VERBOSE_BOOLEAN = (CString)"SDL.gpu.device.create.verbose"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_VULKAN_DEPTHCLAMP_BOOLEAN = (CString)"SDL.gpu.device.create.vulkan.depthclamp"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_VULKAN_DRAWINDIRECTFIRST_BOOLEAN = (CString)"SDL.gpu.device.create.vulkan.drawindirectfirstinstance"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_VULKAN_SAMPLERANISOTROPY_BOOLEAN = (CString)"SDL.gpu.device.create.vulkan.sampleranisotropy"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_VULKAN_SHADERCLIPDISTANCE_BOOLEAN = (CString)"SDL.gpu.device.create.vulkan.shaderclipdistance"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_DRIVER_INFO_STRING = (CString)"SDL.gpu.device.driver_info"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_DRIVER_NAME_STRING = (CString)"SDL.gpu.device.driver_name"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_DRIVER_VERSION_STRING = (CString)"SDL.gpu.device.driver_version"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_NAME_STRING = (CString)"SDL.gpu.device.name"u8;
    ...
    public static readonly CString SDL_PROP_PROCESS_CREATE_CMDLINE_STRING = (CString)"SDL.process.create.cmdline"u8;
    ...
    public static readonly CString SDL_PROP_PROCESS_CREATE_WORKING_DIRECTORY_STRING = (CString)"SDL.process.create.working_directory"u8;
    ...
    public static readonly CString SDL_PROP_RENDERER_CREATE_GPU_SHADERS_DXIL_BOOLEAN = (CString)"SDL.renderer.create.gpu.shaders_dxil"u8;

    public static readonly CString SDL_PROP_RENDERER_CREATE_GPU_SHADERS_MSL_BOOLEAN = (CString)"SDL.renderer.create.gpu.shaders_msl"u8;

    public static readonly CString SDL_PROP_RENDERER_CREATE_GPU_SHADERS_SPIRV_BOOLEAN = (CString)"SDL.renderer.create.gpu.shaders_spirv"u8;
    ...
    public static readonly CString SDL_PROP_SURFACE_HOTSPOT_X_NUMBER = (CString)"SDL.surface.hotspot.x"u8;

    public static readonly CString SDL_PROP_SURFACE_HOTSPOT_Y_NUMBER = (CString)"SDL.surface.hotspot.y"u8;
    ...
    public static readonly CString SDL_PROP_WINDOW_CREATE_RAIN_POPUP_BOOLEAN = (CString)"SDL.window.create.constrain_popup"u8;

    public static readonly CString SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_CANVAS_ID_STRING = (CString)"SDL.window.create.emscripten.canvas_id"u8;

    public static readonly CString SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_KEYBOARD_ELEMENT_STRING = (CString)"SDL.window.create.emscripten.keyboard_element"u8;
    ...
    public static readonly CString SDL_PROP_WINDOW_EMSCRIPTEN_CANVAS_ID_STRING = (CString)"SDL.window.emscripten.canvas_id"u8;

    public static readonly CString SDL_PROP_WINDOW_EMSCRIPTEN_KEYBOARD_ELEMENT_STRING = (CString)"SDL.window.emscripten.keyboard_element"u8;
    ...
    public static readonly int SDL_VERSION = (int)3003000;
    ...
    public partial struct SDL_AssertData
    {
        ...
        [FieldOffset(8)]
        public CString condition; // size = 8
    ...
    public partial struct SDL_GPUBlitInfo
    {
        ...
        [FieldOffset(68)]
        public Rgba32F clear_color; // size = 16
    ...
    public partial struct SDL_GPUComputePipelineCreateInfo
    {
        ...
        [FieldOffset(16)]
        public CString entrypoint; // size = 8
    ...
    public partial struct SDL_GPUMultisampleState
    {
        ...
        [FieldOffset(9)]
        public CBool enable_alpha_to_coverage; // size = 1
    ...
    [StructLayout(LayoutKind.Explicit, Size = 64, Pack = 8)]
    public partial struct SDL_GPURenderStateDesc
    {
        [FieldOffset(0)]
        ...
        [FieldOffset(16)]
        public int num_sampler_bindings; // size = 4

        [FieldOffset(24)]
        public SDL_GPUTextureSamplerBinding* sampler_bindings; // size = 8

        [FieldOffset(32)]
        public int num_storage_textures; // size = 4

        [FieldOffset(40)]
        public SDL_GPUTexture** storage_textures; // size = 8

        [FieldOffset(48)]
        public int num_storage_buffers; // size = 4

        [FieldOffset(56)]
        public SDL_GPUBuffer** storage_buffers; // size = 8
    }
    ...
    public partial struct SDL_hid_device_info
    {
        ...
        [FieldOffset(16)]
        public IntPtr serial_number; // size = 8

        [FieldOffset(24)]
        public ushort release_number; // size = 2

        [FieldOffset(32)]
        public IntPtr manufacturer_string; // size = 8

        [FieldOffset(40)]
        public IntPtr product_string; // size = 8
    ...
    {
        [FieldOffset(0)]
        public CString language; // size = 8

        [FieldOffset(8)]
        public CString country; // size = 8
    }
    ...
    public partial struct SDL_MouseWheelEvent
    {
        ...
        [FieldOffset(44)]
        public int integer_x; // size = 4

        [FieldOffset(48)]
        public int integer_y; // size = 4
    }
    ...
    public partial struct SDL_Event
    {
        ...
        [FieldOffset(0)]
        public SDL_MouseWheelEvent wheel; // size = 56
    ...
    public enum SDL_ProgressState : int
    {
    ...
    public enum SDL_TextureAddressMode : int
    {
    ...
    public enum SDL_Capitalization : int
    {
    ...
    public enum SDL_ChromaLocation : int
    {
    ...
    public enum SDL_ColorPrimaries : int
    {
    ...
    public enum SDL_ColorRange : int
    {
    ...
    public enum SDL_GPUCubeMapFace : int
    {
    ...
    public enum SDL_MatrixCoefficients : int
    {
    ...
    public enum SDL_TextInputType : int
    {
    ...
    public enum SDL_TransferCharacteristics : int
    {
    ...
    [StructLayout(LayoutKind.Sequential)]
    public partial struct SDL_MouseMotionTransformCallback
    {
        public delegate* unmanaged[Cdecl]<void*, ulong, SDL_Window*, SDL_MouseID, float*, float*, void> Pointer;

        public SDL_MouseMotionTransformCallback(delegate* unmanaged[Cdecl]<void*, ulong, SDL_Window*, SDL_MouseID, float*, float*, void> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public partial struct FnPtr_VoidPtr_Ulong_SDLWindowPtr_SDLMouseID_FloatPtr_FloatPtr_Void
    {
        public delegate* unmanaged[Cdecl]<void*, ulong, SDL_Window*, SDL_MouseID, float*, float*, void> Pointer;

        public FnPtr_VoidPtr_Ulong_SDLWindowPtr_SDLMouseID_FloatPtr_FloatPtr_Void(delegate* unmanaged[Cdecl]<void*, ulong, SDL_Window*, SDL_MouseID, float*, float*, void> pointer)
        {
            Pointer = pointer;
        }
    }
