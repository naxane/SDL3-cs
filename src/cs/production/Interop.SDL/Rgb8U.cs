...
/// <inheritdoc />
/// <summary>
///     A pixel color value type with 8 bits each for the 4 un-signed integer components: red, green, blue.
/// </summary>
/// <remarks>
///     <para>
...
public partial struct Rgb8U : IEquatable<Rgb8U>
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="Rgb8U" /> structure using specified <see cref="byte" /> values.
    /// </summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="Rgb8U" /> struct using a <see cref="uint" /> packed RGBA value.
    /// </summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="Rgb8U" /> struct using a hexadecimal <see cref="uint" /> packed RGBA
    ///     value.
    /// </summary>
    ...
    /// <returns> The <see cref="Rgb8U" /> struct resulting from converting <paramref name="value" />.</returns>
    ...
    /// <inheritdoc />
    public readonly bool Equals(Rgb8U other)
    {
