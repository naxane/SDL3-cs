...
/// </summary>
/// <remarks>
///     <para>Each format corresponds to a specific <see cref="Driver" /> that accepts it.</para>
/// </remarks>
[PublicAPI]
[Flags]
public enum GraphicsShaderFormats
{
    /// <summary>
    ///     Shader data format is not specified.
    /// </summary>
    None = 0,
    ...
    ///     This format is specific to <see cref="Driver.Vulkan" />.
    /// </summary>
    /// <remarks>
    ...
    ///     This format is specific to <see cref="Driver.DirectX12" />.
    /// </summary>
    /// <remarks>
    ...
    ///     This format is specific to <see cref="Driver.Metal" />.
    /// </summary>
    /// <remarks>
