...
/// <summary>
///     Defines the different strategies for how texels of a <see cref="Texture" /> are mapped into fragments (pixels)
///     when rendering with a <see cref="GraphicsShader" />, also known as sampling. Depending on the strategy chosen
...
///             </item>
///         </list>
///         Magnification and minification can be set for a <see cref="Texture" /> in the
///         <see cref="TextureDescriptor" /> when calling <see cref="Device.TryCreateTexture" />.
///     </para>
/// </remarks>
[PublicAPI]
