...
///     </para>
///     <para>
///         To create a <see cref="GraphicsPipeline" />, call <see cref="Device.TryCreatePipeline" /> with the
///         specified <see cref="GraphicsPipelineDescriptor" /> struct.
///     </para>
///     <para>
///         To activate a <see cref="GraphicsPipeline" /> for rendering, and by consequence deactivate any other
///         active <see cref="GraphicsPipeline" />, call <see cref="RenderPass.BindPipeline" />.
///     </para>
/// </remarks>
[PublicAPI]
public sealed unsafe class GraphicsPipeline : Resource
{
