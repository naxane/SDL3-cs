...
/// </remarks>
[PublicAPI]
public sealed class GraphicsPipelineRasterizerState
{
    /// <summary>
    ///     Gets or sets the way primitives of type
    ///     <see cref="GraphicsPipelineVertexPrimitiveType.TriangleList" /> or
    ///     <see cref="GraphicsPipelineVertexPrimitiveType.TriangleStrip" /> are filled.
    /// </summary>
    public GraphicsPipelineFillMode FillMode { get; set; }

    /// <summary>
    ///     Gets or sets the facing direction in which primitives will be culled.
    /// </summary>
    public GraphicsPipelineCullMode CullMode { get; set; }

    /// <summary>
    ///     Gets or sets the vertex winding that determines a front-facing primitive.
    /// </summary>
    public GraphicsPipelineFrontFace FrontFace { get; set; }
    ...
    public void Reset()
    {
        FillMode = GraphicsPipelineFillMode.Fill;
        CullMode = GraphicsPipelineCullMode.None;
        FrontFace = GraphicsPipelineFrontFace.CounterClockwise;
