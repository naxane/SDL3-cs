...
/// <summary>
///     A mapped pointer from a <see cref="GpuTransferBuffer" /> along with it's size in bytes.
/// </summary>
[PublicAPI]
public readonly ref struct GpuTransferBufferPointer
{
    /// <summary>
    ...
    internal GpuTransferBufferPointer(IntPtr pointer, int byteCount)
    {
        Pointer = pointer;
        ByteCount = byteCount;
    }
