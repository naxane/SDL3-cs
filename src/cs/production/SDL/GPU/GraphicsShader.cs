...
/// </remarks>
[PublicAPI]
public sealed unsafe class GraphicsShader : Resource
{
    /// <summary>
    ///     Gets the <see cref="GraphicsShaderFormats " /> of the graphics shader.
    /// </summary>
    public GraphicsShaderFormats Format { get; private set; }

    /// <summary>
    ///     Gets the <see cref="GraphicsShaderStage" /> of the graphics shader.
    /// </summary>
    public GraphicsShaderStage Stage { get; private set; }

    internal GraphicsShader(
        GPU.Device device,
        IntPtr handle,
        GraphicsShaderFormats format,
