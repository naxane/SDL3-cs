...
/// <remarks>
///     <para>
///         <see cref="CopyPass" /> instances are <b>not</b> pooled and must not be used or referenced after calling
///         <see cref="RenderPass.End" />. To get a <see cref="CopyPass" /> instance call
///         <see cref="GPU.CommandBuffer.BeginCopyPass" />.
///     </para>
/// </remarks>
[PublicAPI]
public unsafe class CopyPass : Resource
{
    /// <summary>
    ...
    internal CopyPass(Device device, IntPtr handle, CommandBuffer commandBuffer)
        : base(device, handle)
    {
