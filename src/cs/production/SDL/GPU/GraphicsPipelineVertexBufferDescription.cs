...
/// <summary>
///     Parameters for creating a <see cref="GraphicsPipeline" /> instance that describe how a single vertex buffer
...
/// </remarks>
[PublicAPI]
public struct GraphicsPipelineVertexBufferDescription
{
    /// <summary>
    ...
    /// </summary>
    public GraphicsPipelineVertexInputRate InputRate;
    ...
    ///     <see cref="GraphicsPipelineVertexInputRate.PerVertex" />. If the value is equal to <c>1</c>, new data is
